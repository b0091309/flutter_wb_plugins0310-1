...
public class FlutterWebviewPlugin implements MethodCallHandler, PluginRegistry.ActivityResultListener {
    ...
    public void onMethodCall(MethodCall call, MethodChannel.Result result) {
        switch (call.method) {
            ...
            case "cleanCache":
                cleanCache(result);
                break;
            case "autoDownloadResource":
                autoDownloadResource(call, result);
                break;
            default:
    ...
    void openUrl(MethodCall call, MethodChannel.Result result) {
        ...
        boolean autoDownloadResource = call.argument("autoDownloadResource");
    ...
    private void autoDownloadResource(MethodCall call, MethodChannel.Result result) {
        boolean isOn = call.argument("autoDownloadResource");
        webViewManager.autoDownloadResource(isOn);
        result.success(null);
    }
