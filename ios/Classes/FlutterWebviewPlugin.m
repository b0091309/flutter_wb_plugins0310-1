...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
    ...
    } else if ([@"autoDownloadResource" isEqualToString:call.method]){
        [self autoDownloadResource:call];
        result(nil);
    }else if ([@"cookieList" isEqualToString:call.method]){
        //TODO
    } else {
...
- (void)initWebview:(FlutterMethodCall*)call withResult:(FlutterResult)result {
    ...
    _autoDownloadResource = call.arguments[@"autoDownloadResource"];
    NSDictionary *cookie = call.arguments[@"cookieList"];
...
- (void) autoDownloadResource:(FlutterMethodCall*) call {
    if(self.webview != nil){
        Boolean permissionOn = call.arguments[@"autoDownloadResource"];
        _autoDownloadResource = permissionOn;
    }
}
...
- (void)webView:(WKWebView *)webView decidePolicyForNavigationAction:(WKNavigationAction *)navigationAction
    ...
    NSLog(@"current url =>:%@",navigationAction.request.URL);
