...
enum WebViewState { shouldStart, startLoad, finishLoad, abortLoad ,jumpToThirdParty}
...
class FlutterWebviewPlugin {
  ...
  Future<Null> launch(String url, {
    ...
    final args = <String, dynamic>{
      ...
      'autoDownloadResource': autoDownloadResource ?? false,
  ...
  Future<Null> autoDownloadResource(bool autoDownloadResource) async {
    final args = <String, dynamic>{
      'autoDownloadResource': autoDownloadResource
    };
    await _channel.invokeMethod('autoDownloadResource', args);
  }
  ...
  factory WebViewStateChanged.fromMap(Map<String, dynamic> map) {
    ...
    switch (map['type']) {
      ...
      case 'abortLoad':
        ...
        break;
      case 'jumpToThirdParty':
        t = WebViewState.jumpToThirdParty;
        break;
    }
